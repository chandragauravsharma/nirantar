                    <?php
                       ...
                       // $lastname = mysql_real_escape_string($lastname);
						...
						$sql = "UPDATE $tbl_name SET ".
                               "custLastName = '$lastname', custFirstName = '$firstname', custAddress = '$address', custCity = '$city', custPhone = '$phone', custMobile = '$mobile', ".
                               "custEmail = '$email', custOtherDetails = '$additionaldetails', custGender = '$gender' ".
                               "WHERE custId = $id";
